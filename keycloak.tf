...
module "keycloak" {
  ...
  external_database_username = data.kubernetes_secret.keycloak_db.data.username
  external_database_password = data.kubernetes_secret.keycloak_db.data.password
